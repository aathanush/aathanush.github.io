...
import { Directive, inject, EventEmitter, TemplateRef, Component, ChangeDetectionStrategy, ContentChild, ViewChild, Input, Output, Pipe, ContentChildren, NgModule } from '@angular/core';
