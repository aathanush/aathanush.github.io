...
class TuiSubheaderCompactComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: TuiSubheaderCompactComponent, isStandalone: true, selector: "[tuiSubheader][compact],[tuiNavigationSubheader][compact]", providers: [PROVIDERS, tuiButtonOptionsProvider({ size: 's' })], ngImport: i0, template: `
