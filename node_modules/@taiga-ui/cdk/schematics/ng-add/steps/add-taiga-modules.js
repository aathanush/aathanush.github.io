...
function addTuiModules({ mainClass, context, }) {
    ...
    (0, ng_morph_1.addProviderToNgModule)(mainClass, 'provideEventPlugins()', { unique: true });
    (0, add_unique_import_1.addUniqueImport)(mainModulePath, 'provideEventPlugins', '@taiga-ui/event-plugins');
