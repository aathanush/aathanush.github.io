...
function saveAddedImports(options) {
    importsToAdd.forEach(({ componentPath, moduleName, moduleSpecifier }) => {
        !options['skip-logs'] &&
            (0, ng_morph_1.infoLog)(`${ng_morph_1.SMALL_TAB_SYMBOL}${ng_morph_1.REPLACE_SYMBOL} add ${moduleName} declaration from ${moduleSpecifier} to ${componentPath}`);
        ...
        if ((0, ng_morph_1.isStandaloneComponent)(ngComponent)) {
            ...
            !options['skip-logs'] &&
                (0, ng_morph_1.successLog)(`${ng_morph_1.SMALL_TAB_SYMBOL}${ng_morph_1.SUCCESS_SYMBOL} ${moduleName} added to\n`);
            return;
        }
