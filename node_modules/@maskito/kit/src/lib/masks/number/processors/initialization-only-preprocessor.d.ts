 ...
 * ```
 */
export declare function createInitializationOnlyPreprocessor({ decimalPseudoSeparators, decimalSeparator, minusSign, postfix, prefix, pseudoMinuses, }: Pick<Required<MaskitoNumberParams>, 'decimalPseudoSeparators' | 'decimalSeparator' | 'minusSign' | 'postfix' | 'prefix'> & {
